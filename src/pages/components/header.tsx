export function Header(props: { routes: {id: string, title: string, component: any}[]}) {
    ...
    return <header id="header">
        <div className="wpo-site-header">
            ...
            <nav className="navigation navbar navbar-expand-lg navbar-light sticky-header sticky-on">
                <div className="container-fluid">
                    <div className="row align-items-center">
                        <div className="col-lg-3 col-md-3 col-3 d-lg-none dl-block">
                            <div className="mobail-menu">
                        ...
                        <div className="col-lg-8 col-md-1 col-1">
                            ...
                            >
                                ...
                                <ul className="nav navbar-nav mb-2 mb-lg-0">
                                    {routes.map(e => (
                                        <li key={e.id} className="menu-item-has-children">
                                            <a onClick={(e) => onPress(e)} data-to-scrollspy-id={e.id} href={`#${e.id}`}>
                                                {e.title}
                                            </a>
                                        </li>
                                    ))}
